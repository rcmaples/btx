...
export interface DynamicArrayCheckboxInputProps extends ArrayOfPrimitivesInputProps {
  query: string
}

/**
 * A custom input component for array of strings that fetches options dynamically from a GROQ query.
 * Renders as checkboxes for multiple selection.
 *
 * @example
 * ```tsx
 * {
 ...
 * ```
 */
export function DynamicArrayCheckboxInput(props: DynamicArrayCheckboxInputProps) {
