...
export function saveCartToStorage(cart: Cart): void {
  ...
  try {
    ...
    window.dispatchEvent(new CustomEvent(CART_UPDATED_EVENT, {detail: cartToStore}))
  } catch (error) {
...
export function findLineItem(lineItems: CartLineItem[], itemId: string): CartLineItem | undefined {
...
export function removeLineItem(lineItems: CartLineItem[], itemId: string): CartLineItem[] {
